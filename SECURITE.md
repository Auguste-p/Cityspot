...
| **A09:2021 – Security Logging and Monitoring Failures** | ⚠️ Partiellement couvert — supervision infra (Prometheus/Grafana), tracking d'erreurs frontend (Sentry), anti brute-force SSH (fail2ban) en place ; télémétrie applicative dédiée aux événements de sécurité (401/403 métier) toujours absente | `MANUEL_DEPLOIEMENT.md` §8.4 ; `src/lib/sentry.ts` | — |
