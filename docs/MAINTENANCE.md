...
**Écart assumé** : les métriques Prometheus/Grafana (infra) sont consultées manuellement (dashboard), aucun Alertmanager configuré dessus — seule la couche sécurité applicative (Sentry) a une alerte automatique active. Cf. §6.
